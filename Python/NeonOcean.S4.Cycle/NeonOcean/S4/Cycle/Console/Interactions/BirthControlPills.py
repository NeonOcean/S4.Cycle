...
def _Setup () -> None:
	...
	commandPrefix = This.Mod.Namespace.lower() + ".birth_control_pills"  # type: str
...
def _TakePill (
	...
	try:
		...
		SafetyBirthControlPills.TakePill(targetSimInfo, pillsObject = pillsObject, requiresPill = requiresPill, removePill = removePill, showGeneralFeedback = showGeneralFeedback, showWarningFeedback = showWarningFeedback)
	except:
